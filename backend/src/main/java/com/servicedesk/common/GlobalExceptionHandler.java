...
import com.servicedesk.common.exception.ApplicationException;
 ...
 * and every error returns a consistent ApiResponse shape with an HTTP status
 * that actually reflects the failure.
 */
